...
namespace DataMapping.Data
{
    public class DT_CounterM: DataTable
    {
        ...
        public const string ID_COLUMNA = "idCounterM";
        ...
        public const string RISK_NAMESHORT_COLUMNA = "Risk";
        public const string DETAIL_COLUMNA = "detail";        
        public const string DIAGONAL_COLUMN = "diagonal";
        public const string FROM_TOP_COLUMN = "fromTop";
        public const string PROBABILITY_COLUMN = "probability";
        public const string POSITION_COLUMN = "position";
        public const string ENABLED_COLUMN = "EnableIt";
        ...
        private void CreateTable()
        {
            ...
            Columns.Add(RISK_NAMESHORT_COLUMNA, typeof(System.String));
            Columns.Add(DETAIL_COLUMNA, typeof(System.String));
            Columns.Add(DIAGONAL_COLUMN, typeof(System.Boolean));
            Columns.Add(FROM_TOP_COLUMN, typeof(System.Boolean));
