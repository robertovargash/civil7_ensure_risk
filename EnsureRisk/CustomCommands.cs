...
namespace EnsureRisk
{
    static class CustomCommands
    {
        ...
        public static RoutedCommand Project = new RoutedCommand();
        public static RoutedCommand User = new RoutedCommand();
        public static RoutedCommand Role = new RoutedCommand();
