    ...
    public class WebServiceRisk : System.Web.Services.WebService
    {
        ...
        public DataSet GetRiskTreeString(object[] param)
        {
            try
            {
                ...
                ds.Tables[10].TableName = DT_CM_WBS.TABLENAME;
        ...
        public DataSet SaveRisk(DataSet ds)
        {
            ...
            try
            {
                ...
                SQLAccessBuilder riskTreeTopRiskDA = new SQLAccessBuilder(trans, ds.Tables[DT_Diagram_Damages.TABLENAME].TableName, ds.Tables[DT_Diagram_Damages.TABLENAME].PrimaryKey);
